...
//                    Block toPlaceBlock = world.GetBlock(CodeWithParts(face.Code));
//                    powerOutFacing = face;
...
//            {
//                BlockFacing bestFacing = Block.SuggestedHVOrientation(byPlayer, blockSel)[0].Opposite;

//                Block orientedBlock = world.BlockAccessor.GetBlock(CodeWithParts(bestFacing.Code));
//                powerOutFacing = bestFacing;
...
//            else
//            {
//                Block orientedBlock = world.BlockAccessor.GetBlock(CodeWithParts(blockSel.Face.Code));
...
//            WasPlaced(world, blockSel.Position, powerOutFacing);
//        }
//        return ok;
//    }
